...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm py-0" style="height: 48px;">
  <div class="container">
    <a href="{{ route('desk', ['currentFolder' => array_shift($nestingLevels)]) }}">
    ...
    <a href="{{ route('text.contents', ['text' => $text]) }}">
...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm py-0">
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      @case(2)
      <li class="breadcrumb-item">
        <a class="btn p-1" href="{{ route('desk', ['currentFolder' => array_pop($nestingLevels)]) }}">
          <img src="{{ asset('icons/archive-cabinet.png') }}" style="height:24px" alt="">
        </a>
      </li>
      <li class="breadcrumb-item">
